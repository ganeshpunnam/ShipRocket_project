// import { ArrowUpRight, CheckCircle2, MapPin, Truck } from "lucide-react"

export default function Stats() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 font-sans">
      <p className="text-sm text-purple-600 mb-4">A trusted growth partner</p>
      <h1 className="text-4xl md:text-4xl font-bold mb-6 leading-tight" style={{ lineHeight: '1.5' }}>
  ...
  {[
    ...
    <div key={index} className="flex flex-col">
      <span className="text-2xl font-bold text-indigo-900">{stat.title}</span>
      ...
      <div className="h-1 w-[80%] bg-gradient-to-r from-purple-400 to-blue-500 mt-2"></div>
        ...
        <img width="1137" height="647" decoding="async" src="https://sr-website.shiprocket.in/wp-content/uploads/2023/07/home-A-trusted-growth-partner-rv.webp" alt="img" data-lazy-src="https://sr-website.shiprocket.in/wp-content/uploads/2023/07/home-A-trusted-growth-partner-rv.webp" data-ll-status="loaded" class="entered lazyloaded"/>
      ...
      <p className="text-4xl bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 bg-clip-text text-transparent">
